...
| 🎴 **扑克牌点名动画** | 纸面遮罩 → 大主牌居中 → 同尺寸牌左右斜上方交替插入（后卡压前卡）→ 暖红闪光收尾 |
...
- **遮罩**：纸面像素遮罩 + 点阵纹理，聚焦中心
- **主牌**：第一张为居中的大牌（字号更大、卡片更宽），从下方三档硬切弹出
- **插牌**：后续同尺寸牌从斜上方交替插入（奇数张左上、偶数张右上），三档硬切滑入
- **叠放**：左右错位随序号递增（10→28px），`Canvas.ZIndex` 递增，后一张压前一张，牌堆逐层变厚
- **收尾**：暖红像素方框闪光扩散后遮罩淡出
